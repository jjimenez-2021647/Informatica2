...
// Obtener el context path desde la variable global (igual que en el ahorcado)
...
function dibujar() {
    ...
    estado.forEach((valor, i) => {
        ...
        if (valor === "") {
            ...
            // CORRECCIÓN: Usar contextPath como en el ahorcado
            img.src = `${contextPath}/Images/` + valor;
            img.alt = valor;
            img.style.width = "100%";
